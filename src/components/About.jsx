        ...
        <>
            <div className='about' id="about-section">
                <div className='about-me'>
                    ...
                    <br/>
                    <br/>
                    Before transitioning into tech, I spent 13 years as a massage therapist — founding and running a successful spa business where I handled everything from marketing to client care to web design. That experience shaped my strong work ethic, creativity, and ability to build things from the ground up.
                    <br/>
                    <br/>
